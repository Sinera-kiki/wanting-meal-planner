...
> 面向独居生活的 AI 周餐规划助手：输入预算、口味、忌口和家中库存，生成一周 9 顿 15 分钟快手餐，并自动推导低损耗采购清单。
...
目标场景默认为工作日 5 顿晚餐、周末 4 顿午晚餐，共 9 顿；每顿控制在 15 分钟左右。
...
| 模块 | 能力 |
|---|---|
| 周计划生成 | 根据预算、口味、忌口、库存生成固定节奏的 9 顿餐单 |
